...
a connection acknowledgemen\t packet response from the server. """
...
if __name__ == '__main__':
    ...
    client.message_callback_add("user/ipinfo/ip", on_ip_message)
    client.message_callback_add("user/ipinfo/date", on_date_message)
